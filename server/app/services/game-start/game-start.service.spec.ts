import { MOCK_NEW_PLAYER_FIVE, MOCK_NEW_PLAYER_FOUR, MOCK_NEW_PLAYER_ORGANIZER, MOCK_NEW_PLAYER_SIX, MOCK_NEW_PLAYER_THREE, MOCK_NEW_PLAYER_TWO, MOCK_ROOM_START_POSITION } from '@app/constants/gameplay.test.constants';
