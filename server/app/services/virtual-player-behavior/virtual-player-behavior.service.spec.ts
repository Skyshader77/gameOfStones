...
import { MOCK_AGGRESSIVE_VIRTUAL_PLAYER, MOCK_CLOSEST_OBJECT_DATA, MOCK_DEFENSIVE_VIRTUAL_PLAYER, MOCK_VIRTUAL_PLAYER_STATE } from '@app/constants/virtual-player-test.constants';
...
describe('VirtualPlayerBehaviorService', () => {
    ...
    describe('defensiveTurnAction', () => {
        it('should prioritize bomb strategy when possible', () => {
            const mockRoom = { ...MOCK_ROOM_ONE_PLAYER_LEFT_WITH_BOTS };    
    ...
    describe('isFightAvailable', () => {
        ...
        describe('hasJustEvadedAndBlocked', () => {
            it('should return true when next to player and just exited fight', () => {
                ...
                const result = service['hasJustEvadedAndBlocked'](
    ...
    describe('createItemStrategy', () => {
        it('should return true and move to item when conditions are met', () => {
            ...
            const strategy = service['createItemStrategy'](
                mockVirtualPlayer, 
                mockClosestObjectData, 
                mockVirtualPlayerState, 
                mockRoom
            );
    ...
    describe('createFightStrategy', () => {
        it('should return false when not next to player', () => {
            ...
            const strategy = service['createFightStrategy'](
                mockVirtualPlayer, 
                mockClosestObjectData, 
                mockVirtualPlayerState, 
                mockRoom
    ...
    describe('createMoveToPlayerStrategy', () => {
        it('should return true and move towards player when not blocked', () => {
            ...
            const strategy = service['createMoveToPlayerStrategy'](
                mockVirtualPlayer, 
                mockClosestObjectData, 
                mockVirtualPlayerState, 
                mockRoom
    ...
    describe('Additional Methods Tests', () => {
        ...
        describe('hasToFight', () => {
            it('should return true when player has obstacle and can fight', () => {
                mockState.obstacle = { x: 1, y: 1 };
                mockAggressiveVirtualPlayer.playerInGame.remainingActions = 1;
                const result = service['hasToFight'](
                    mockAggressiveVirtualPlayer, 
                    mockClosestObjectData.closestPlayer.position, 
                    mockState
                );
                expect(result).toBeTruthy();
            });
        ...
        describe('Strategies', () => {
            describe('createOffensiveItemStrategy', () => {
                it('should return a strategy that returns true when offensive item is reachable', () => {
                    ...
                    const strategy = service['createOffensiveItemStrategy'](
                        mockAggressiveVirtualPlayer, 
                        closestOffensiveItem, 
                        mockRoom
                    );
