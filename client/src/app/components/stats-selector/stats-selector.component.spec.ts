...
describe('StatsSelectorComponent', () => {
    ...
    it('should set hpSpeedControl to "hp" when "Vie" button is clicked', () => {
        const hpRadioButton = fixture.debugElement.query(By.css('#stat-' + PlayerAttributes.Hp));
        expect(hpRadioButton).toBeTruthy();

        if (hpRadioButton) {
            hpRadioButton.nativeElement.click();
            fixture.detectChanges();
            expect(component.hpSpeedControl.value).toBe(PlayerAttributes.Hp);
        }
    });

    it('should set hpSpeedControl to "speed" when "Rapidité" button is clicked', () => {
        const speedRadioButton = fixture.debugElement.query(By.css('#stat-' + PlayerAttributes.Speed));
        expect(speedRadioButton).toBeTruthy();

        if (speedRadioButton) {
            speedRadioButton.nativeElement.click();
            fixture.detectChanges();
            expect(component.hpSpeedControl.value).toBe(PlayerAttributes.Speed);
        }
    });
    ...
    it('should set attackDefenseControl to "attack" when "Attaque" button is clicked', () => {
        const attackRadioButton = fixture.debugElement.query(By.css('#stat-' + PlayerAttributes.Attack));
        expect(attackRadioButton).toBeTruthy();

        attackRadioButton.nativeElement.click();
        fixture.detectChanges();
        expect(component.attackDefenseControl.value).toBe(PlayerAttributes.Attack);
    });

    it('should set attackDefenseControl to "defense" when "Défense" button is clicked', () => {
        const defenseRadioButton = fixture.debugElement.query(By.css('#stat-' + PlayerAttributes.Defense));
        expect(defenseRadioButton).toBeTruthy();

        defenseRadioButton.nativeElement.click();
        fixture.detectChanges();
        expect(component.attackDefenseControl.value).toBe(PlayerAttributes.Defense);
    });
