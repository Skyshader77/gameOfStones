...
import { MapInfoAdminComponent } from '@app/components/map-info-admin/map-info-admin.component';
...
@Component({
    ...
    imports: [RouterLink, FontAwesomeModule, MapInfoAdminComponent, MapListAdminComponent, MapCreationFormComponent],
})
